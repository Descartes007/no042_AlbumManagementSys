                          ...
                          <TR>
                            <TD>
                              ...
                              cellPadding=0 width="100%">
                                ...
                                <TR>
                                <TD class=xh height=44 vAlign=top 
                                align=left>
                                <center>
                               <font size="3"> <strong><%=map.get("title") %></strong></font>
                                <br /><br />
                                
                                
                             <%=map.get("author").equals("")?"":("作者 : "+map.get("author")+"&nbsp;&nbsp;&nbsp;") %> 
                             <%=map.get("source").equals("")?"":("来源 : "+map.get("source")+"&nbsp;&nbsp;&nbsp;") %>  
