                          ...
                          <TR>
                            <TD>
                              ...
                              width="100%" align=left>
                                ...
                                align=left><STRONG>空间分享</STRONG></TD>
                          ...
                          <TR>
                            <TD>
                              ...
                              cellPadding=0 width="100%">
                                ...
                                PageManager pageManager = PageManager.getPage("byfx.jsp?1=1",16, request);
                                String sql = "select * from members where ispub='是' ";
                                if(!key.equals(""))
                                {
                                sql+="and jbs like'%"+key+"%' ";
                                }
                                ...
                                <A href="grzy.jsp?zyuname=<%=m.get("uname") %>" target=_self>
                                    <font color="orange"><%=m.get("uname") %></font>
                                     <%=Info.subStr(m.get("jbs").toString(),50)  %>
                                    </A> 
