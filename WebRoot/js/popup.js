...
function uploadimg()
{
pop("/photoalbum/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/photoalbum/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/photoalbum/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/photoalbum/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/photoalbum/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/photoalbum/js/uploaddoc.jsp","docupload",300,77)
}

function uploaddoc2()
{
pop("/photoalbum/js/uploaddoc2.jsp","docupload",300,77)
}

function uploaddoc3()
{
pop("/photoalbum/js/uploaddoc3.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/photoalbum/js/dialogclose.gif  />';
   ...
   if(this.config.contentType==1){var openIframe="<iframe width='100%' style='height:500px' name='"+this.iframeIdName+"' id='"+this.iframeIdName+"' src='"+this.info.contentUrl+"' frameborder='0' scrolling='"+this.config.scrollType+"'></iframe>";
...
{   
if(inputs[jj].style.display==''&&inputs[jj].disabled==false){
 inputs[jj].focus();
break;
}
