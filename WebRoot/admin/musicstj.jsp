...
new CommDAO().insert(request,response,"musics",ext,true,true); 
%>
<body>
  <form  action="musicstj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
