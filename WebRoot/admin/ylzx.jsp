...
//-->
 ...
 <script>
			       function add()
			       {
			       pop("/photoalbum/admin/addylzx.jsp","添加信息",700,'100%');
			       }
			       
			        function update(no)
			       {
			       pop("/photoalbum/admin/updateylzx.jsp?id="+no,"修改信息",700,'100%');
			       }
  </script>
<%
...
<%
 ...
 %>
  <form action="/photoalbum/admin/ylzx.jsp?f=f" name="f1"  method="post">
    <%

 String hql = "select * from mixinfo where infotype='站内动态' ";
        String url = "/photoalbum/admin/ylzx.jsp?1=1";
    ...
    <td height="154"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F7F7F7" class="main_desk_table">
      ...
      <table width="100%" border="0" 
          ...
          <tr 
            ...
            <td width="" align="center" class="main_title_td_center2">来源</td>
       ...
       for(HashMap m:nlist)
       {
         ...
         %>
          ...
          <tr 
            ...
            <td width="" align="center" valign="middle" class="main_matter_td"><%=m.get("source") %></td>
            ...
            <a href="ylzx.jsp?did=<%=m.get("id") %>">删除</a>            </td>
          </tr>
          <%
           } %>
