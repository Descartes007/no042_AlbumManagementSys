...
new CommDAO().update(request,response,"photos",ext,true,true); 
HashMap mmm = new CommDAO().getmap(id,"photos"); 
%>
<body>
  <form  action="webphotosxg.jsp?f=f&id=<%=mmm.get("id")%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="76%" align="left" class="main_matter_td"><%=Info.getselect("ptype","albums","cname~无名","uname='"+uname+"'")%><label id='clabelptype' />
</td>
                </tr>
<tr 
              onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'" 
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="76%" align="left" class="main_matter_td"><%=Info.getselect("bgmusic","musics","mname~无名","uname='"+uname+"'")%><label id='clabelbgmusic' />
</td>
                </tr>
<tr 
              onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#f0f7ff'" 
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="76%" align="left" class="main_matter_td">
                   ...
                   <input type=text value="<%=mmm.get("filename") %>"  class='textBox' id='filename' name='filename' size=65 />
                  <br />
...
<%=Info.tform(mmm)%> 
<script language=javascript >  
 document.getElementById("filename").value="<%=mmm.get("filename")%>";
</script>   
