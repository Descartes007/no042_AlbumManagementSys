...
if(suc!=null)
{
 ...
 <script language=javascript>
 alert("操作成功");
 window.parent.location.replace("/photoalbum/admin/members.jsp");
 </script>
 <%
 }
  %>
...
<%
 ...
 %>
  <form action="/photoalbum/photoalbum?ac=addmembers" name="f1"  method="post">
    <%
        ...
        <td><table width="100%" border="0" 
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  <td width="577" align="center" class="main_matter_td">姓名</td>
