...
<body>
  <form  action="webphotoscx.jsp"  name="f1" method="post"  >
...
所属相册 
&nbsp;:&nbsp; 
<%=Info.getselect("ptype","albums","cname","uname='"+uname+"'")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
String url = "webphotoscx.jsp?1=1&ptype="+pptype+"&phoname="+pphoname+""; 
...
&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a onclick="return confirm('确定要删除这条记录吗?')"  href="webphotoscx.jsp?scid=<%=map.get("id")%>">删除</a>
</td>
</tr>
<%}%>
...
<script language=javascript> 
function update(no){ 
pop('webphotosxg.jsp?id='+no,'信息修改',550,'100%') 
}
</script> 
<script language=javascript> 
function add(){ 
pop('webphotostj.jsp','信息添加',550,'100%') 
}
</script> 
<%@page import="util.Info"%> 
