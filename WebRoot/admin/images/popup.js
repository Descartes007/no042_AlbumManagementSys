...
function pop(purl,ptitle,pwid,phei)
{
                  var pop=new Popup({ contentType:1,isReloadOnClose:false,width:pwid,height:phei});
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/photoalbum/admin/images/dialogclose.gif  />';
