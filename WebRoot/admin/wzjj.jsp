...
CommDAO dao = new CommDAO();
 ...
 dao.commOper("update mixinfo set content='"+content+"' where infotype='网站简介'");
 }
 HashMap map = dao.select("select * from mixinfo where infotype='网站简介'").get(0);

 %>
  <form action="/photoalbum/admin/wzjj.jsp?f=f" name="f1"  method="post">
