...
new CommDAO().insert(request,response,"photos",ext,true,false); 
%>
<body>
  <form  action="photostj.jsp?f=f&tglparentid=<%=tglparentid%>"     name="f1" method="post"  onsubmit="return checkform()" >
           ...
           <td width="118" class="main_title_td_center">相关信息</td>
            ...
            cellspacing="0" rules="all" style="WIDTH: 100%; BORDER-COLLAPSE: collapse">
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="84%" align="left" class="main_matter_td"><%=Info.getselect("ptype","albums","cname~无名","uname='"+uname+"'")%> 
...
<tr 
              ...
              onmouseout="this.style.backgroundColor=currentcolor">
                  ...
                  <td width="84%" align="left" class="main_matter_td"><%=Info.getselect("bgmusic","musics","mname~无名","uname='"+uname+"'")%> 
